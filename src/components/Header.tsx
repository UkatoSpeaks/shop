  ...
  return (
    <header className="sticky top-0 z-50 w-full px-4 sm:px-6 lg:px-8 pt-4">
      <div className="max-w-7xl mx-auto">
        <div className="glass rounded-[2.5rem] px-8 h-20 grid grid-cols-2 lg:grid-cols-3 items-center gap-4 shadow-sm">
          {/* Logo & Nav (Left) */}
            ...
            <nav className="hidden xl:flex items-center gap-6">
              {[
                ...
                <Link 
                  key={item.label} 
                  href={item.href} 
                  className="text-[11px] font-bold text-gray-500 hover:text-gray-900 uppercase tracking-widest transition-colors relative group"
                >
                  {item.label}
